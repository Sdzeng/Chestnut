package com.arbor.chestnut.common.util;
...
public final class WebUtil {
	...
	public static final void saveCurrentUser(Object user) {
		setSession(OperationCode.CURRENT_USER, user);
	}
	...
	public static final String getCurrentUser() {
		...
		if (null != currentUser) {
			...
			if (null != session) {
				return (String) session.getAttribute(OperationCode.CURRENT_USER);
			}
		}
		return null;
	}
	...
	public static final void removeCurrentUser(HttpServletRequest request) {
		request.getSession().removeAttribute(OperationCode.CURRENT_USER);
	}
